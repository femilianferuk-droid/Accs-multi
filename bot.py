...
Полные интеграции: Crypto Bot API + YooMoney API
"""
...
# Остальные хендлеры (создание бота, управление и т.д.)
...
async def edit_category_menu(callback: CallbackQuery):
    ...
    try:
        ...
        builder = InlineKeyboardBuilder()
        builder.row(InlineKeyboardButton(text="✏️ Изменить", callback_data=f"rename_cat_{cat_id}"))
